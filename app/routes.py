...
@bp.route('/loads/<int:load_id>', methods=['GET'])
...
@bp.route('/loads/<int:load_id>', methods=['PUT'])
...
@bp.route('/loads/<int:load_id>', methods=['DELETE'])
...
# Carrier CRUD 
@bp.route('/carriers', methods=['POST'])
def create_carrier():
    data = request.get_json()
...
@bp.route('/carriers/<int:carrier_id>', methods=['GET'])
...
@bp.route('/carriers/<int:carrier_id>', methods=['PUT'])
...
@bp.route('/carriers/<int:carrier_id>', methods=['DELETE'])
...
# ProduceItem CRUD 
@bp.route('/produce_items', methods=['POST'])
...
@bp.route('/produce_items/<int:produce_item_id>', methods=['GET'])
...
@bp.route('/produce_items', methods=['GET'])
...
@bp.route('/produce_items/<int:produce_item_id>', methods=['PUT'])
...
@bp.route('/produce_items/<int:produce_item_id>', methods=['DELETE'])
